...
public sealed class CommandDurationSegmentBuilderTests
{
    ...
    public void Build_WhenShowCommandDurationIsFalse_ShouldReturnEmpty()
    {
        ...
        using var _ = ConfigReader.OverrideForTesting(new ConfigDto { CommandDuration = new ConfigDto.CommandDurationConfig { Show = false } });
    ...
    public void Build_WhenShowCommandDurationIsTrueAndDurationIsNull_ShouldReturnEmpty()
    {
        ...
        using var _ = ConfigReader.OverrideForTesting(new ConfigDto { CommandDuration = new ConfigDto.CommandDurationConfig { Show = true } });
    ...
    public void Build_WhenDurationExceedsMinimumThreshold_ShouldReturnSegment()
    {
        ...
        using var _ = ConfigReader.OverrideForTesting(new ConfigDto { CommandDuration = new ConfigDto.CommandDurationConfig { Show = true, MinMs = 2000 } });
    ...
    public void Build_WhenMinimumThresholdIsNull_ShouldAlwaysShowDuration()
    {
        ...
        using var _ = ConfigReader.OverrideForTesting(new ConfigDto { CommandDuration = new ConfigDto.CommandDurationConfig { Show = true, MinMs = null } });
    ...
    public void Build_WhenMinimumThresholdIsZero_ShouldAlwaysShowDuration()
    {
        // Arrange
        var platformProvider = new TestPlatformProvider(lastCommandDurationMs: 1);
        using var _ = ConfigReader.OverrideForTesting(new ConfigDto { CommandDuration = new ConfigDto.CommandDurationConfig { Show = true, MinMs = 0 } });
