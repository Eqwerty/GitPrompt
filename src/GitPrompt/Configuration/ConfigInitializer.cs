    ...
    internal static Config MergeWithDefaults(ConfigDto userConfig)
    {
        return new Config
        {
            ...
            Colors = new Config.ColorsConfig
            {
                ...
                BranchNoUpstream = userConfig.Colors?.BranchNoUpstream ?? ColorDisplayValue(AnsiColors.Cyan),
                BranchGoneUpstream = userConfig.Colors?.BranchGoneUpstream ?? ColorDisplayValue(AnsiColors.Cyan),
                BranchDetached = userConfig.Colors?.BranchDetached ?? ColorDisplayValue(AnsiColors.DarkGray),
                ...
                Stash = userConfig.Colors?.Stash ?? ColorDisplayValue(AnsiColors.BrightBlack),
